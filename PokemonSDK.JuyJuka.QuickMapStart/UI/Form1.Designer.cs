namespace PokemonSDK.JuyJuka.QuickMapStart.UI
{
    ...
    private void InitializeComponent()
    {
      ...
      // textBoxImage
      // 
      this.textBoxImage.Location = new Point(344, 3);
      this.textBoxImage.Name = "textBoxImage";
      this.textBoxImage.ReadOnly = true;
      this.textBoxImage.Size = new Size(250, 35);
      this.textBoxImage.TabIndex = 5;
      // 
      // button1
      // 
      this.button1.Location = new Point(685, 3);
      this.button1.Name = "button1";
      this.button1.Size = new Size(131, 34);
      ...
      this.tabControl1.Size = new Size(1038, 861);
      ...
      this.tabPage1.Size = new Size(1030, 818);
      ...
      // tabPagePreview
      // 
      this.tabPagePreview.Controls.Add(this.tabControlPreviews);
      this.tabPagePreview.Location = new Point(4, 39);
      this.tabPagePreview.Name = "tabPagePreview";
      this.tabPagePreview.Size = new Size(1030, 818);
      this.tabPagePreview.TabIndex = 2;
      this.tabPagePreview.Text = "Previes";
      ...
      this.tabControlPreviews.SelectedIndex = 0;
      ...
      // tabPage4
      // 
      this.tabPage4.Controls.Add(this.flowLayoutPanelZoom);
      this.tabPage4.Controls.Add(this.label8);
      this.tabPage4.Location = new Point(4, 42);
      ...
      // flowLayoutPanelZoom
      // 
      this.flowLayoutPanelZoom.Controls.Add(this.button2);
      ...
      this.flowLayoutPanelZoom.Size = new Size(1016, 736);
      this.flowLayoutPanelZoom.TabIndex = 0;
      // 
      // button2
      // 
      this.button2.Location = new Point(3, 3);
      this.button2.Name = "button2";
      this.button2.Size = new Size(131, 40);
      ...
      // button4
      // 
      this.button4.Location = new Point(140, 3);
      this.button4.Name = "button4";
      this.button4.Size = new Size(131, 40);
      ...
      // button5
      // 
      this.button5.Location = new Point(277, 3);
      this.button5.Name = "button5";
      this.button5.Size = new Size(131, 40);
      ...
      // button6
      // 
      this.button6.Location = new Point(414, 3);
      ...
      this.label8.Size = new Size(67, 30);
      ...
      this.tabPageSmall.Controls.Add(this.pictureBoxSmall);
      this.tabPageSmall.Location = new Point(4, 42);
      this.tabPageSmall.Name = "tabPageSmall";
      this.tabPageSmall.Size = new Size(1022, 772);
      this.tabPageSmall.TabIndex = 2;
      this.tabPageSmall.Text = "Small";
      this.tabPageSmall.UseVisualStyleBackColor = true;
      // 
      // pictureBoxSmall
      // 
      this.pictureBoxSmall.Location = new Point(0, 0);
      this.pictureBoxSmall.Name = "pictureBoxSmall";
      this.pictureBoxSmall.Size = new Size(175, 88);
      this.pictureBoxSmall.SizeMode = PictureBoxSizeMode.StretchImage;
      this.pictureBoxSmall.TabIndex = 0;
      this.pictureBoxSmall.TabStop = false;
      // 
      // tabPageBig
      // 
      this.tabPageBig.AutoScroll = true;
      this.tabPageBig.Controls.Add(this.pictureBoxBig);
      this.tabPageBig.Location = new Point(4, 42);
      this.tabPageBig.Name = "tabPageBig";
      this.tabPageBig.Padding = new Padding(3);
      this.tabPageBig.Size = new Size(1022, 772);
      this.tabPageBig.TabIndex = 1;
      this.tabPageBig.Text = "Big";
      this.tabPageBig.UseVisualStyleBackColor = true;
      // 
      // pictureBoxBig
      // 
      this.pictureBoxBig.Location = new Point(0, 0);
      this.pictureBoxBig.Name = "pictureBoxBig";
      this.pictureBoxBig.Size = new Size(175, 88);
      this.pictureBoxBig.SizeMode = PictureBoxSizeMode.StretchImage;
      ...
      this.statusStrip1.Location = new Point(0, 861);
      this.statusStrip1.Name = "statusStrip1";
      this.statusStrip1.Size = new Size(1038, 39);
      ...
      this.toolStripStatusLabel1.Size = new Size(86, 30);
      this.toolStripStatusLabel1.Text = "Hello :-)";
      this.toolStripStatusLabel1.Click += this.toolStripStatusLabel1_Click;
      // 
      // toolStripProgressBar1
      // 
      this.toolStripProgressBar1.AutoSize = false;
      this.toolStripProgressBar1.Name = "toolStripProgressBar1";
      this.toolStripProgressBar1.Size = new Size(400, 29);
      ...
      this.ClientSize = new Size(1038, 900);
      this.Controls.Add(this.tabControl1);
      this.Controls.Add(this.statusStrip1);
      this.Name = "Form1";
      this.Text = "PokemonSDK.JuyJuka.QuickMapStart";
    ...
    private NumericUpDown numericUpDownMaxY;
    ...
    private TabControl tabControlPreviews;
    private TabPage tabPage4;
    private TabPage tabPageBig;
    private TabPage tabPageSmall;
    private PictureBox pictureBoxSmall;
    private PictureBox pictureBoxBig;
    private FlowLayoutPanel flowLayoutPanelZoom;
    ...
    private TabPage tabPagePreviewMaps;
